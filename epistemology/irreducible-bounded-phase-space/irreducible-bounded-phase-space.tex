...
re-coarsening to undo a commitment is a distinct act, not a reversal of the
...
the same time the part verified and a portion of the totality against which it is
