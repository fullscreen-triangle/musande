...
and the two-pronged falsification of point-identity. \Cref{sec:validation}
exhibits every result on explicitly constructed instances and reports an
exhaustive numerical check. \Cref{sec:master} proves the Master Theorem and
concludes.
