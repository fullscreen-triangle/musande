...
A Comprehensive Calculus of Purpose, Belief Incompatibility,\\
...
Per-experiment JSON outputs are stored in
...
\begin{itemize}[leftmargin=*]
\item Panel 1: receiver foundations and cell-truth (\Cref{fig:panel1}).
\item Panel 2: multi-agent algebra and catalytic composition
(\Cref{fig:panel2}).
\item Panel 3: common-cell convergence and reachability
(\Cref{fig:panel3}).
\item Panel 4: purpose, motivation heterogeneity, and replication
(\Cref{fig:panel4}).
\item Panel 5: cell-meaning, residue, bias, and cell exteriority
(\Cref{fig:panel5}).
\end{itemize}

\begin{figure}[h!]\centering
\includegraphics[width=0.95\textwidth]{validation/figures/panel_1.png}
\caption{\textbf{Receiver foundations and cell-truth.} See
captions file for details.}
\label{fig:panel1}
\end{figure}

\begin{figure}[h!]\centering
\includegraphics[width=0.95\textwidth]{validation/figures/panel_2.png}
\caption{\textbf{Multi-agent algebra and catalytic composition.}}
\label{fig:panel2}
\end{figure}
